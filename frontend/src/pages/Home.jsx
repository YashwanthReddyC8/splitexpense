...
const Home = () => {
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-brand-red/10 selection:text-brand-red">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <Link
                to="/login"
                className="text-sm font-medium text-gray-700 hover:text-brand-red px-4 py-2 rounded-lg border border-gray-200 hover:border-brand-red transition-all"
              >
                Log In
              </Link>
              <Link
                to="/register"
                className="text-sm font-medium text-white bg-brand-red hover:bg-red-700 px-5 py-2 rounded-lg shadow-sm shadow-brand-red/20 transition-all"
              >
                Sign Up
              </Link>
            </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
            <div className="lg:col-span-6 text-center lg:text-left">
              ...
              <p className="mt-6 text-lg text-gray-500 max-w-2xl mx-auto lg:mx-0">
                The simplest way to split bills, track expenses, and settle up
                with your group. Perfect for trips, roommates, and outings.
              </p>

              <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                <Link
                  to="/register"
                  className="w-full sm:w-auto px-8 py-4 bg-brand-red text-white font-bold rounded-xl shadow-lg shadow-brand-red/30 hover:bg-brand-red/90 hover:-translate-y-0.5 transition-all text-lg"
                >
                  Get Started
                </Link>
      ...
      <section
        className="py-24 mx-30 bg-brand-red-light/50 border-y border-brand-red/5"
        id="features"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                desc: "Travel, friends, flatmates or family",
              },
              {
                icon: Receipt,
                title: "Add Expenses in Seconds",
                desc: "Quickly track who paid and what",
              },
              {
                icon: RefreshCcw,
                title: "Settle Up Easily",
                desc: "Request or pay instantly via UPI",
              },
              {
                icon: ChartNoAxesColumn,
                title: "Track & Settle",
                desc: "Keep track of balances clearly",
              },
            ].map((f, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div>
                  <h3 className="font-bold text-gray-900 group-hover:text-brand-red transition-colors">
                    {f.title}
                  </h3>
            ...
            {[
              {
                ...
                desc: "Create a new group or join an existing one with your friends.",
              },
              {
                step: "2",
                title: "Add expenses",
                desc: "Add expenses and select who paid and who participated.",
              },
              {
                step: "3",
                title: "Settle up",
                desc: "View balances and settle up instantly using UPI payments.",
              },
            ].map((s, i) => (
              <div
                key={i}
                className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1 text-center relative"
              >
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Split Expense was built to end the hassle of splitting bills and
                tracking who owes what. Whether it's a trip, dinner, or monthly
                rent, we make group expenses simple, transparent, and
                stress-free.
              </p>
            ...
            <div className="mt-12 lg:mt-0 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow flex items-center gap-4"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-brand-red rounded-[3rem] px-8 py-16 lg:p-20 text-center relative overflow-hidden">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6 relative">
              Ready to simplify your <br className="hidden sm:block" /> group
              expenses?
            </h2>
            <p className="text-red-100 text-lg mb-10 max-w-2xl mx-auto relative">
              Join thousands of users who trust Split Expense to manage their
              group finances perfectly.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative">
              <Link
                to="/register"
                className="w-full sm:w-auto px-10 py-4 bg-white text-brand-red font-bold rounded-xl shadow-lg hover:bg-gray-50 hover:-translate-y-0.5 transition-all"
              >
                Sign Up Now
              </Link>
              <Link
                to="/login"
                className="w-full sm:w-auto px-10 py-4 bg-brand-red border-2 border-white/30 text-white font-bold rounded-xl hover:bg-white/10 transition-all"
              >
                Log In
              </Link>
            </div>
